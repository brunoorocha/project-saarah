...
class DefaultCellTableViewCell: SaarahTableViewCell {
    ...
    override func configureCellComponents() {
        contentView.addSubviews([label, detailLabel, separator, arrowRightIcon])
        ...
        NSLayoutConstraint.activate([
            ...
            arrowRightIcon.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -mediumMargin),
            arrowRightIcon.centerYAnchor.constraint(equalTo: contentView.centerYAnchor),
