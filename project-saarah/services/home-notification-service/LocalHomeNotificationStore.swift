...
class LocalHomeNotificationStore: HomeNotificationStoreProtocol {
    static var notifications: [HomeNotification] = [
        ...
        HomeNotification(emoji: "🎅🏻", message: "Jingle Bell! O Natal está chegando. Que tal revisar o estoque para ver se é necessário repor alguns items e atender os seus clientes sem surpresas.", type: .normal)
    ]
